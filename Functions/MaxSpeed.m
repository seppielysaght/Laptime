function [Speed,CSpeed, ASpeed] = MaxSpeed(Tyre, Torque, PreviousSpeed, Distance, Car, FRLatMax, FLLatMax, RRLatMax, RLLatMax, CornerRadius, FRVert, FLVert, RRVert, RLVert, dragF)
